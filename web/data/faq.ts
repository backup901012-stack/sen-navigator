...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    id: "ot-confidence",
    category: "基礎認識",
    q: "職業治療點樣幫 SEN 孩子建立自信？",
    a: "自信來自一次次「我做得到」的成功經驗，而非單純讚賞。職業治療（OT）透過提升孩子的日常能力來建立信心：用「剛剛好的挑戰」（難度調到孩子踮起腳就做到）、把任務分解循序漸進、以遊戲為本、先用感覺統合穩定情緒、提升自理與小肌肉技能、用合適工具與環境調適減少挫敗。家長在家可：讚努力與過程多於結果、給有限選擇、容許失敗再試、慶祝小進步、減少代勞。讓孩子靠自己成功，比替他做更能建立長遠自信。詳見網站「職業治療如何幫 SEN 兒童建立自信」頁。",
    sources: [
      { label: "職業治療如何建立自信 — 基礎認識頁", url: "/ot-confidence", checkedAt: "2026-06" },
    ],
  },
  {
    id: "tcm",
  ...
  },
  {
    id: "odd",
    category: "基礎認識",
    q: "孩子成日發脾氣、頂嘴、反抗，是「對立反抗症」(ODD) 嗎？",
    a: "對立反抗症（ODD）是 DSM-5 的正式診斷，指持續至少 6 個月、明顯超出同齡的「憤怒易怒、好辯反抗、甚至報復」模式，並影響日常生活。約 5% 兒童受影響、男孩較多，並很常與 ADHD 共病。重要的是：ADHD 孩子的「反抗」很多時源於衝動控制困難、並非故意作對；自閉症孩子亦可能因溝通、固執或感官不適而出現對立行為。先理解行為背後成因，比單純責罰有效。處理上以家長管教訓練、正向獎勵、先處理共病為主。是否屬 ODD 須由專業評估。詳見網站「對立反抗症 ODD」頁。",
    sources: [
      { label: "對立反抗症 ODD — 基礎認識頁", url: "/odd", checkedAt: "2026-06" },
    ],
  },
  {
    id: "brain",
